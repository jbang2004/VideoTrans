  ...
  return (
    <div className="w-full h-full overflow-hidden">
      ...
      >
        ...
        <div 
          className={cn(
            "control-bar absolute left-0 right-0 bottom-4 px-4 transition-opacity duration-300 z-20",
            showControls ? "opacity-100" : "opacity-0"
          )}
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
          <div className="glass-effect-dark rounded-full px-4 py-2 flex items-center justify-between gap-3 w-full shadow-lg">
            {/* 左侧控件：上传和播放/暂停 */}
